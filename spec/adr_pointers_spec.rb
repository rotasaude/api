...
# Guarda de numeração do corpus de ADRs. O v2 vai de 0001 a 0018; qualquer
...
RSpec.describe "ADR pointers" do
  ...
  it "only points at ADRs that exist in the v2 corpus (0001..0018)" do
